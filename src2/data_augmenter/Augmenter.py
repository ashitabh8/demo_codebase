...
from .NoAugmenter import NoAugmenter
from .MissAugmenter import MissAugmenter
from .MixupAugmenter import MixupAugmenter
from .JitterAugmenter import JitterAugmenter
from .PermutationAugmenter import PermutationAugmenter
from .ScalingAugmenter import ScalingAugmenter
from .NegationAugmenter import NegationAugmenter
from .HorizontalFlipAugmenter import HorizontalFlipAugmenter
from .ChannelShuffleAugmenter import ChannelShuffleAugmenter
from .TimeMaskAugmenter import TimeMaskAugmenter
from .FreqMaskAugmenter import FreqMaskAugmenter
...
class Augmenter:
    ...
    def load_time_augmenters(self, args):
        ...
        self.time_augmenter_pool = {
            ...
            "band_limited_noise": BandLimitedNoiseAugmenter,
            "audio_noise": AudioNoiseAugmenter,
        }

...
class SingleModalConvOnly(nn.Module):
    """
    Single-modality ConvOnly model with configurable architecture.
...
if __name__ == "__main__":
    # Example 1: ConvOnlyNet basic usage
    print("=" * 60)
    print("Example 1: ConvOnlyNet")
    print("=" * 60)
    ...
    # Example 2: SingleModalConvOnly - Audio (ACIDS)
    print("\n" + "=" * 60)
    print("Example 2: SingleModalConvOnly - Audio (ACIDS)")
    print("=" * 60)
    ...
    # Example 3: SingleModalConvOnly - Seismic (ACIDS)
    print("\n" + "=" * 60)
    print("Example 3: SingleModalConvOnly - Seismic (ACIDS)")
    print("=" * 60)
    ...
    # Example 4: Tiny ConvOnly for size estimation
    print("\n" + "=" * 60)
    print("Example 4: Size Comparison - Various Configurations")
    print("=" * 60)
